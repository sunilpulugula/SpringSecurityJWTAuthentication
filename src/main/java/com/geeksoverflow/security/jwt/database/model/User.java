...
public class User implements Serializable {
    ...
    public User(final String userId, final String name, final String password, final String phoneno, final Integer active, final String provider, final Set<Role> roles) {
        this.userId = userId;
        this.name = name;
